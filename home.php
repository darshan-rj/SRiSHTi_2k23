...
<head>
    ...
    <title>SRiSHTi 2K23 | HOME</title>

    <link rel="stylesheet" href="css/home.css">
    <link rel="stylesheet" href="css/marequee.css">
...
<body>
    <header>
        <nav class="navbar fixed-bottom mb-4">
            <div class="container mx-auto">
                <a class="navbar-brand d-flex gap-5 align-items-center" href="#">
                    <img src="assets/icons/srishti-logo.png" alt="" width="28px">
                    <p class="my-auto">Menu</p>
                </a>
                <a class="toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar"
                    aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
                    <img src="assets/icons/menu-outline.svg" alt="" id="navbar-toggler-icon"
                        class="navbar-toggler-icon">
                </a>
                <div class="offcanvas offcanvas-bottom h-auto" tabindex="-1" id="offcanvasNavbar"
                    aria-labelledby="offcanvasNavbarLabel">
                    <div class="offcanvas-header justify-content-end">
                        <!-- <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Menu</h5> -->
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div id="offcanvas-body" class="offcanvas-body p-5">
                        <ul class="navbar-nav justify-content-end flex-grow-1 px-4 pb-2">
                        <li class="nav-item d-flex align-items-center gap-2 ">
                            ...
                            <ul class="menu gap-2 list-unstyled ms-4">
                                <li class="nav-item d-flex align-items-center gap-2 ">
                                    <img src="assets/icons/microchip-solid.svg" alt="">
                                    <a class="nav-link" href="./events.html#tech-events">Technical</a>
                                </li>
                                <li class="nav-item d-flex align-items-center gap-2 ">
                                    <img src="assets/icons/laptop-file-solid.svg" alt="">
                                    <a class="nav-link" href="#">Non-Technical</a>
                                </li>
                                <li class="nav-item d-flex align-items-center gap-2 ">
                                    <img src="assets/icons/laptop-file-solid.svg" alt="">
                                ...
                                <li class="nav-item d-flex align-items-center gap-2 ">
                                    <img src="assets/icons/person-chalkboard-solid.svg" alt="">
                                    <a class="nav-link" href="#">Paper Presentation</a>
                                </li>
                                <li class="nav-item d-flex align-items-center gap-2 ">
                                    <img src="assets/icons/robot-solid.svg" alt="">
                                    <a class="nav-link" href="#">Bot Events</a>
                                </li>
                            </ul>
                            <li class="nav-item d-flex align-items-center gap-2 ">
                                <img src="assets/icons/flag-regular.svg" alt="">
                                <a class="nav-link" href="#">Flagship</a>
                            </li>
                            <li class="nav-item d-flex align-items-center gap-2 ">
                                <img src="assets/icons/at-solid.svg" alt="">
    ...
    <main>
        ...
        <section class="top-nav my-4">
            <div class="container px-4 py-2 d-flex justify-content-between align-items-center align-content-center w-100">
                ...
                <a href="login.php" class="reg-btn">Register</a>
            </div>
        </section>
        ...
        <section class="hero">
            <div id="hero-container" class="container">
                <div class="mt-5 text-center">
                    <h2 class="hero-title">DISCOVER THE TRHILL OF INNOVATION</h2>
                    <div class="logo d-flex flex-wrap justify-content-center align-items-center align-content-center">
                <img class="img-fluid" src="assets/icons/SRiSHTi-logo (Traced)2.svg" alt="">
            </div>
                </div>
                <div class="wrapper mt-5 py-5">
                    <svg>
            ...
            <div class="container">
                <div class="row d-flex justify-content-center align-items-center gx-5">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="abt-mask"></div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <h2 class="abt-title">About <br> <span>IEEE Students Chapter <span>12951</span></span></h2>
                        <p class="about-desc">
                            The Students’ Chapter of IEEE at PSG College of Technology was initiated in 1977. It was
                            started to involve the students in research and encourage new ideas in the respective
                            fields. PSG has always been known to set benchmarks in terms of quality of engineering
                            and
                            is one of the first and foremost institutions to have a Students branch of IEEE. The
                            IEEE
                            Students Chapter of PSG Tech has been actively involved in organizing top notch
                            technical
                            fests every year that has evoked the interest and involvement of students from various
                            parts
                            of the country. It is the biggest technical association at PSG College of Technology.
                        </p>
                    </div>
        ...
        <section class="sponsor">
            <h1 class="spon-title text-center">Our Sponsors</h1>
            <article class="container wrapper">
                <div class="marquee rounded-4">
                ...
                <div class="marquee marquee--reverse rounded-4">
                    <div class="marquee__group">
                        <svg>
                            <use xlink:href="#hulu" />
                        </svg>
        ...
        <div class="events my-5">
            <div class="container">
                <h2 class="section-title text-center my-5">EVENTS</h2>
                <div class="row d-flex justify-content-center align-items-center flex-wrap align-content-center">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio voluptas
                            aspernatur
                            mollitia libero! In, modi id porro doloremque quam neque laboriosam commodi officiis, nemo
                            voluptates similique! Quod consequatur ab quis!</p>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="events-deck">
                            <div class="row gap-3">
                                <div class="card">
                                    <div class="card-title">TECHNICAL</div>
                                </div>
                                <div class="card">
                                    <div class="card-title">NON-TECHNICAL</div>
                                </div>
                                <div class="card">
                                    <div class="card-title">BOT EVENTS</div>
                                </div>
                                <div class="card">
                                    <div class="card-title">WORKSHOP</div>
                                </div>
                                <div class="card">
                                    <div class="card-title">PAPER PRESENTATION</div>
                                </div>
                                <div class="card">
                                    <div class="card-title">FLAGSHIP</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="faq-section my-5">
            <div
                class="container d-flex flex-column justify-content-center align-items-center flex-wrap align-content-center p-2 py-4">
                <h2 class="section-title text-center my-5">FAQ QUESTIONS</h2>
                <div
                    class="row my-4 d-flex flex-row flex-wrap justify-content-center align-itemms-center align-content-center g-4">
                            ...
                            <div class="accordion__wrapper">
                                <dl class="accordion__box">
                                    <dt class="accordion__patition">
                                        ...
                                        <span class="accordion__title">Payments</span>
                                    </dt>
                                    <dd class="accordion__text" <ul>
                                        <li>Subscribe</li>
                                        <li>Like</li>
                                        <li>Comment</li>
                                        <p>If it was helpful, I will really appreciate if you support this channel!
                                        </p>
                                        </ul>
                                    </dd>
                                </dl>
                            ...
                            <div class="accordion__wrapper">
                                <dl class="accordion__box">
                                    <dt class="accordion__patition">
                                        ...
                                        <span class="accordion__title">Accomodation</span>
                                    </dt>
                                    <dd class="accordion__text" <ul>
                                        <li>Subscribe</li>
                                        <li>Like</li>
                            ...
                            <div class="accordion__wrapper">
                                <dl class="accordion__box">
                                    <dt class="accordion__patition">
                                        ...
                                        <span class="accordion__title">Registration</span>
                                    </dt>
                                    <dd class="accordion__text" <ul>
                                        <li>Subscribe</li>
                                        <li>Like</li>
        ...
        <div id="ft-container" class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="f-logo">
                        <img src="assets/icons/SRiSHTi-full (Traced).svg" alt="" width="200px" height="200px">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="ft-menu">
                    <ul class="ft-menu-items">
                        <li class="ft-menu-item">
                            <a href="" class="ft-menu-link">Home</a>
                        </li>
                        <li class="ft-menu-item">
                            <a href="" class="ft-menu-link">Events</a>
                        </li>
                        <li class="ft-menu-item">
                            <a href="" class="ft-menu-link">Workshops</a>
                        </li>
                        <li class="ft-menu-item">
                            <a href="" class="ft-menu-link">Paper Presentation</a>
                        </li>
                        <li class="ft-menu-item">
                            <a href="" class="ft-menu-link">Bot Events</a>
                        </li>
                        <li class="ft-menu-item">
                            <a href="" class="ft-menu-link">Flagship</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="ft-contact">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="contact-details mx-auto">
                                <li class="contact-item">
                                    <img src="assets/icons/phone-call.svg" alt="">
                                    <a class="contact-link" href="">SASHANK TM</a>
                                </li>
                                <li class="contact-item">
                                    <img src="assets/icons/phone-call.svg" alt="">
                                    <a class="contact-link" href="">KRISHNA RS</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script>
        VANTA.FOG({
            ...
            minHeight: 200.00,
            minWidth: 200.00,
            highlightColor: 0xa2a2a2,
            midtoneColor: 0x595959,
            lowlightColor: 0x424242,
            baseColor: 0x333333,
            blurFactor: 0.25,
            speed: 0.5,
            zoom: 0.50
